...
import com.paymentology.nfc_card_reader.module.enums.CommandEnum;
...
import com.paymentology.nfc_card_reader.module.iso7816emv.EmvTags;
import com.paymentology.nfc_card_reader.module.iso7816emv.EmvTerminal;
import com.paymentology.nfc_card_reader.module.iso7816emv.TLV;
import com.paymentology.nfc_card_reader.module.iso7816emv.TagAndLength;
import com.paymentology.nfc_card_reader.module.model.Afl;
import com.paymentology.nfc_card_reader.module.model.EmvCard;
import com.paymentology.nfc_card_reader.module.model.EmvTransactionRecord;
import com.paymentology.nfc_card_reader.module.model.enums.CurrencyEnum;
import com.paymentology.nfc_card_reader.module.utils.CommandApdu;
import com.paymentology.nfc_card_reader.module.utils.ResponseUtils;
import com.paymentology.nfc_card_reader.module.utils.TlvUtil;
import com.paymentology.nfc_card_reader.module.utils.TrackUtils;
...
public class EmvParser {
    ...
    protected byte[] parseFCIProprietaryTemplate(final byte[] pData) throws CommunicationException {
        ...
        if (data != null) {
            ...
            /*byte[] cryptographicDataRes = provider.transceive(
                    new CommandApdu(
                            CommandEnum.COMPUTE_CRYPTOGRAPHIC_CHECKSUM,
                            new byte[]{(byte) 0x04, (byte) 0x00, (byte) 0x00, (byte) 0x08}, 0x00)
                            .toBytes());

            card.cryptographicData = Arrays.toString(cryptographicDataRes);*/
